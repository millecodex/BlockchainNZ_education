...
<p align="center"><img width="800" alt="Uniswap pool schematic" src="https://user-images.githubusercontent.com/39792005/149286434-c50bca1f-8ab0-4c11-a4a1-ff0624e9b1fc.jpeg"></p>

> Creating a pool (from the [Uniswap docs](https://docs.uniswap.org/protocol/V2/concepts/core-concepts/pools)) shows...


To create a pool I just need equal dollar amounts of two assets and through the protocol deposit them into a smart contract. At this point I am issued an LP (liquidity provider) token representing the combined assets, for example from Uniswap: `USDC-ETH-LP-v2`, meaning a proportional amount of the USDC-ETH pool as an LP for version 2. This is the receipt proving my commitment and I must hold onto this `USDC-ETH-LP-v2` token to be able to withdraw liquidity and claim any rewards. At this point I'm exposed to second-degree market effects as the independent fluctuation in price of both tokens affects my position. More on this later in *impermanent loss*.
