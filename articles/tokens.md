...
1. [Token Standards](template.md#second)
...
Back to the tag being a token. The digital representation has many of the same properties, namely it is fungible (interchangeable), secure (can't be stolen), scarce (can't be copied), valuable (someone would pay for it), and has utility (otherwise why do I need it?). Additionally we have described many of the properties of money itself, and this may be why a distinction between cryptocurrencies, utility tokens, securities, and collectibles can be fuzzy and subjective.
